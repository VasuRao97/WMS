...
export const DEFAULT_EQUIPMENT_SUITABILITY: Record<string, SuitabilityRow> = {
  'Manual (Hand Carry)': {
    putawaySuitability: 'SECONDARY',
    pickingSuitability: 'SECONDARY',
    loadingSuitability: 'NOT_USED',
    unloadingSuitability: 'SECONDARY',
    consolidationSuitability: 'SECONDARY',
    inventoryCheckSuitability: 'PRIMARY',
  },
  'Hand Held Trolley': {
    putawaySuitability: 'SECONDARY',
    pickingSuitability: 'PRIMARY',
    loadingSuitability: 'SECONDARY',
    unloadingSuitability: 'SECONDARY',
    consolidationSuitability: 'SECONDARY',
    inventoryCheckSuitability: 'SECONDARY',
  },
  'HOPT (Hand Pallet Truck)': {
    putawaySuitability: 'SECONDARY',
    pickingSuitability: 'NOT_USED',
    loadingSuitability: 'PRIMARY',
    unloadingSuitability: 'PRIMARY',
    consolidationSuitability: 'SECONDARY',
    inventoryCheckSuitability: 'NOT_USED',
  },
  'BOPT (Battery Pallet Truck)': {
    putawaySuitability: 'SECONDARY',
    pickingSuitability: 'NOT_USED',
    loadingSuitability: 'PRIMARY',
    unloadingSuitability: 'PRIMARY',
  ...
  'Stacker (Walkie/Rider)': {
    putawaySuitability: 'PRIMARY',
    pickingSuitability: 'SECONDARY',
    loadingSuitability: 'SECONDARY',
    unloadingSuitability: 'SECONDARY',
    consolidationSuitability: 'SECONDARY',
